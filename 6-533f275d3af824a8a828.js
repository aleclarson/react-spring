  ...
  [6],
  {
    ...
    '8Ppc': function (t, e, r) {
      ...
      ;(function (t) {
        ...
        var u = 'navigator' in t && /Win/i.test(navigator.platform),
          f =
            'navigator' in t &&
            /(Mac|iPhone|iPod|iPad)/i.test(navigator.platform),
          l = 'npm__react-simple-code-editor__textarea',
          c = (function (t) {
            function e() {
              var t, r, o
              a(this, e)
              ...
              return (
                ...
                (o._getLines = function (t, e) {
                  return t.substring(0, e).split('\n')
                }),
                (o._recordChange = function (t) {
                  var e =
                      arguments.length > 1 &&
                      void 0 !== arguments[1] &&
                      arguments[1],
                    ...
                    a = r.offset
                  if (i.length && a > -1) {
                    o._history.stack = i.slice(0, a + 1)
                    var s = o._history.stack.length
                    if (s > 100) {
                      var u = s - 100
                      ;(o._history.stack = i.slice(u, s)),
                        (o._history.offset = Math.max(o._history.offset - u, 0))
                    }
                  }
                  var f = Date.now()
                  if (e) {
                    var l = o._history.stack[o._history.offset]
                    if (l && f - l.timestamp < 3e3) {
                      var c = /[^a-z0-9]([a-z0-9]+)$/i,
                        h = o
                          ._getLines(l.value, l.selectionStart)
                          .pop()
                          .match(c),
                        p = o
                  ...
                  o._history.stack.push(n({}, t, { timestamp: f })),
                    o._history.offset++
                }),
                (o._updateInput = function (t) {
                  var e = o._input
                  e &&
                    ((e.value = t.value),
                    (e.selectionStart = t.selectionStart),
                    (e.selectionEnd = t.selectionEnd),
                    o.props.onValueChange(t.value))
                }),
                (o._applyEdits = function (t) {
                  var e = o._input,
                    r = o._history.stack[o._history.offset]
                  r &&
                    e &&
                    (o._history.stack[o._history.offset] = n({}, r, {
                ...
                (o._undoEdit = function () {
                  ...
                  n &&
                    (o._updateInput(n),
                    (o._history.offset = Math.max(r - 1, 0)))
                }),
                (o._redoEdit = function () {
                  ...
                  n &&
                    (o._updateInput(n),
                    (o._history.offset = Math.min(r + 1, e.length - 1)))
                }),
                (o._handleKeyDown = function (t) {
                  var e = o.props,
                    r = e.tabSize,
                    n = e.insertSpaces,
                    i = e.ignoreTabKey,
                  ...
                  if (!a || (a(t), !t.defaultPrevented)) {
                    ...
                    var s = t.target,
                      ...
                      h = s.selectionEnd,
                      p = (n ? ' ' : '\t').repeat(r)
                    if (9 === t.keyCode && !i && o.state.capture)
                      if ((t.preventDefault(), t.shiftKey)) {
                        var g = o._getLines(l, c),
                          y = g.length - 1,
                          d = o._getLines(l, h).length - 1,
                          v = l
                            .split('\n')
                            .map(function (t, e) {
                              return e >= y && e <= d && t.startsWith(p)
                        ...
                        if (l !== v) {
                          ...
                          o._applyEdits({
                            value: v,
                            selectionStart: m.startsWith(p) ? c - p.length : c,
                            selectionEnd: h - (l.length - v.length),
                          })
                        }
                      } else if (c !== h) {
                        var b = o._getLines(l, c),
                          w = b.length - 1,
                          _ = o._getLines(l, h).length - 1,
                          E = b[w]
                        o._applyEdits({
                          value: l
                            .split('\n')
                            ...
                            .join('\n'),
                          selectionStart: /\S/.test(E) ? c + p.length : c,
                          selectionEnd: h + p.length * (_ - w + 1),
                        })
                      } else {
                        var S = c + p.length
                        o._applyEdits({
                          value: l.substring(0, c) + p + l.substring(h),
                          selectionStart: S,
                          selectionEnd: S,
                        })
                      }
                      ...
                      var C = c !== h
                      if (l.substring(0, c).endsWith(p) && !C) {
                        t.preventDefault()
                        var A = c - p.length
                        o._applyEdits({
                          value: l.substring(0, c - p.length) + l.substring(h),
                          selectionStart: A,
                          selectionEnd: A,
                        })
                      }
                      ...
                      if (c === h) {
                        var P = o._getLines(l, c).pop().match(/^\s+/)
                        if (P && P[0]) {
                          t.preventDefault()
                          var R = '\n' + P[0],
                            k = c + R.length
                          o._applyEdits({
                            value: l.substring(0, c) + R + l.substring(h),
                            selectionStart: k,
                            selectionEnd: k,
                          })
                        }
                      ...
                      t.altKey
                        ...
                        : (t.preventDefault(), o._undoEdit())
                  }
                }),
                (o._handleChange = function (t) {
                  var e = t.target,
                    r = e.value,
                    n = e.selectionStart,
                    i = e.selectionEnd
                  o._recordChange(
                    { value: r, selectionStart: n, selectionEnd: i },
                    !0
                  ),
                    o.props.onValueChange(r)
                }),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return i.createElement(
                      'div',
                      n({}, C, { style: n({}, h.container, o) }),
                      i.createElement('textarea', {
                        ref: function (e) {
                          return (t._input = e)
                        },
                        style: n({}, h.editor, h.textarea, A),
                        className: l,
                        id: u,
                        value: r,
                      ...
                      i.createElement(
                        ...
                        n(
                          {
                            'aria-hidden': 'true',
                            style: n({}, h.editor, h.highlight, A),
                          },
                          'string' == typeof P
                            ? {
    ...
    dKp2: function (t, e, r) {
      ...
      var n = r('q1tI'),
        ...
        w = (function (t) {
          function e() {
            var r, i
            y(this, e)
            for (var a = arguments.length, f = Array(a), l = 0; l < a; l++)
              f[l] = arguments[l]
            return (
              (r = i = b(this, t.call.apply(t, [this].concat(f)))),
              (i.state = { code: '' }),
              (i.updateContent = function (t) {
                i.setState({ code: t }, function () {
                  i.props.onChange && i.props.onChange(i.state.code)
                })
              }),
              (i.highlightCode = function (t) {
                return o.a.createElement(
                  s.a,
                  {
                    Prism: u.a,
                    code: t,
                    theme: i.props.theme || p,
                    language: i.props.language,
                  },
                  function (t) {
                    var e = t.tokens,
                      r = t.getLineProps,
        ...
        C = function (t) {
          return Object(l.a)(t, S).code
        },
        A = function (t, e) {
          return (function (r) {
            function n() {
              return y(this, n), b(this, r.apply(this, arguments))
            }
            return (
              v(n, r),
              ...
              (n.prototype.render = function () {
                return 'function' == typeof t ? o.a.createElement(t, null) : t
              }),
              n
            )
          })(n.Component)
        ...
        T = (function (t) {
          function e() {
            ...
            for (var o = arguments.length, i = Array(o), a = 0; a < o; a++)
              i[a] = arguments[a]
            return (
              (r = n = b(this, t.call.apply(t, [this].concat(i)))),
              ...
              (n.transpile = function (t) {
                var e = t.code,
                  ...
                  i = t.noInline,
                  a = void 0 !== i && i,
                  s = { code: o ? o(e) : e, scope: r },
                  u = function (t) {
                    return n.setState({ element: void 0, error: t.toString() })
                  },
                  f = function (t) {
                    return n.setState(d({}, l, { element: t }))
                  },
                  l = { unsafeWrapperError: void 0, error: void 0 }
                try {
                  a
                    ? (n.setState(d({}, l, { element: null })), k(s, f, u))
                    : f(R(s, u))
                } catch (c) {
                  n.setState(d({}, l, { error: c.toString() }))
                }
              }),
              b(n, r)
            )
      ...
      function O(t) {
        return o.a.createElement(_.Consumer, null, function (e) {
          ...
          return o.a.createElement(
            w,
            d({ theme: i, code: r, language: n, disabled: a, onChange: s }, t)
          )
        })
      }
      function B(t) {
        return o.a.createElement(_.Consumer, null, function (e) {
          var r = e.error
          return r ? o.a.createElement('pre', t, r) : null
        })
      }
      function I(t) {
        var e = t.Component,
        ...
        return o.a.createElement(
          e,
          r,
          o.a.createElement(_.Consumer, null, function (t) {
            var e = t.element
            return e && o.a.createElement(e, null)
          })
        )
      }
      ;(T.defaultProps = {
      ...
      ;(e.read = function (t, e, r, n, o) {
        ...
        (e.write = function (t, e, r, n, o, i) {
          ...
          for (
            e = Math.abs(e),
              isNaN(e) || e === 1 / 0
                ...
                : ((a = Math.floor(Math.log(e) / Math.LN2)),
                  ...
                  (e += a + c >= 1 ? h / u : h * Math.pow(2, 1 - c)) * u >= 2 &&
                    (a++, (u /= 2)),
                  a + c >= l
                    ? ((s = 0), (a = l))
                    : a + c >= 1
            ...
            o >= 8;
            t[r + p] = 255 & s, p += g, s /= 256, o -= 8
          );
          for (
            a = (a << o) | s, f += o;
            f > 0;
            t[r + p] = 255 & a, p += g, a /= 256, f -= 8
          );
          t[r + p - g] |= 128 * y
        })
    },
...
//# sourceMappingURL=6-533f275d3af824a8a828.js.map
